    ...
    return(
        ...
        <div className="card w-50">
                <div className="card-body">
                    ...
                    <p>At first glance it may seem that my experience and studies are irrelevant to programming, but there are some powerful intersections between technology, art, psychology and medical science that I am really excited to be a part of. 
